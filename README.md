...
- It does not require super user (root) account.
...
## Input: a VCF file
Any VCF file following the standard format (e.g., [https://samtools.github.io/hts-specs/VCFv4.2.pdf](https://samtools.github.io/hts-specs/VCFv4.2.pdf)). It can be generated by GATK, samtools, freebayes, or anything else.
...
- inheritance: inheritance model, autosomal recessive or dominant
assoc_pheno_genes(^:mutated,*:known_pathogenic): genes known to be associated with the disease (^:does this gene have a mutated variant in the patient VCF file?, *: if yes, then variant is reported to a known pathogenic in either ClinVar or HGMD?)
...
- A.12: Divine is free for academic or research purpose. Contact to hongc2@ccf.org for a commercial use.
